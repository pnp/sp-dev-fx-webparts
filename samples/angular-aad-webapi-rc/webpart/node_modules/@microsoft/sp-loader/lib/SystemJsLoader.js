    ...
    SystemJsLoader.prototype.configure = function (manifest) {
        ...
        for (var name_1 in resources) {
            if (resources[name_1].type === 'component') {
                ...
                if (ManifestStore_1.default.instance.getManifest(moduleConfiguration.id)) {
                    depsMap[name_1] = normalizeName_1.default(ManifestStore_1.default.instance.getManifest(moduleConfiguration.id));
                }
