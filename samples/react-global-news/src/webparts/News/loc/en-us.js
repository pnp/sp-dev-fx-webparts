define([], function() {
  return {
    ...
    ConfigureWebPartMessage: "Configure Nexus News web part",
    ...
    APILabelText: "APIKEY use on API Calls, Please go to www.newsapi.org see more details",
    PageSizeLabel: "Number of Articles per page",
    ViewOption: "View Option",
    ViewSettings: "View Settings",
    Title: "Title",
    "PropertyPaneDescription": "This Web Part Get News from newsapi.org API, please go to www.newsapi.org for more information.",
    "BasicGroupName": "News",
