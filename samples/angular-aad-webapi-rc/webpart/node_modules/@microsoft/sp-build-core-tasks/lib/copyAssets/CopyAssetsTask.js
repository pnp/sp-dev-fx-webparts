...
var CopyAssetsTask = (function (_super) {
    ...
    CopyAssetsTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        bundleEntries.forEach(function (bundleEntry) {
            ...
            _this._processEntry(deployEntry, shouldPrepareProductionDeployment, stringsModuleId, tasks);
    ...
    CopyAssetsTask.prototype._processEntry = function (deployEntry, shouldPrepareProductionDeployment, stringsModuleId, tasks) {
        var _this = this;
