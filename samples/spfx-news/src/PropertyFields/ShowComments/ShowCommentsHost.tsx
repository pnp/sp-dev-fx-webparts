...
import { IShowCommentsComponentProps } from '../../models/IShowCommentsProps';

const ShowCommentsHost: React.FC<IShowCommentsComponentProps> = ({
  label,
  value,
  theme,
  onChange,
  ...
  return (
    <FluentUIProvider
      ...
      applicationName="newfeed-showcomments-property-pane"
    >
...
export default ShowCommentsHost;
