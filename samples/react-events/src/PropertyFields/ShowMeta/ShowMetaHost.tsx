...
import { IShowMetaComponentProps } from '../../models/IShowMetaProps';

const ShowMetaHost: React.FC<IShowMetaComponentProps> = ({ label, value, theme, onChange }) => {
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName="eventsfeed-showmeta-property-pane" styles={{ background: 'transparent' }}>
