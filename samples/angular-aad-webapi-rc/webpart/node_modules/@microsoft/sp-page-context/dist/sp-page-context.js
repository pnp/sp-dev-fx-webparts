define("1c4541f7-5c31-41aa-9fa8-fbc9dc14c0a8", ["@ms/sp-telemetry","@microsoft/sp-core-library","@microsoft/sp-http"], function(__WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_14__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPListItem = (function () {
	    ...
	    Object.defineProperty(SPListItem.prototype, "permissions", {
	        get: function () {
	            return this._permissions;
	        },
	        enumerable: true,
	...
	var SharePointPageContextDataProvider = (function () {
	    ...
	    SharePointPageContextDataProvider._createPageContextData = function (spPageContextInfo) {
	        return {
	            ...
	            listItem: spPageContextInfo.pageItemId && spPageContextInfo.pageItemId !== -1 ? {
	                ...
	                permissions: spPageContextInfo.pagePermsMask
	            } : undefined,
	            site: {
	    ...
	    SharePointPageContextDataProvider.prototype.fetchComponentContextInfo = function (serverRelativePageUrl) {
	        ...
	        return new Promise(function (complete) {
	            _this._httpClient.get(serverRelativePageUrl + '/_api/ComponentContextInfo', sp_http_1.SPHttpClientConfigurations.v1)
