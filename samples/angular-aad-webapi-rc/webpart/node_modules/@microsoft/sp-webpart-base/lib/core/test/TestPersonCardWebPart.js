...
var serializedServerContent = {
    htmlStrings: {
        'websites[0].description': lodash.escape(runtimePropertyBag.websites[0].description),
        'manager.websites[0].description': lodash.escape(runtimePropertyBag.manager.websites[0].description)
    },
    imageSources: {
        'photo': lodash.escape(runtimePropertyBag.photo),
        'manager.photo': lodash.escape(runtimePropertyBag.manager.photo)
    },
    links: {
        'websites[0].url': lodash.escape(runtimePropertyBag.websites[0].url),
        'websites[1].url': lodash.escape(runtimePropertyBag.websites[1].url),
        'manager.websites[0].url': lodash.escape(runtimePropertyBag.manager.websites[0].url)
    }
};
