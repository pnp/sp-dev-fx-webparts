...
import { IShowOrganizerComponentProps } from '../../models/IShowOrganizerProps';

const ShowOrganizerHost: React.FC<IShowOrganizerComponentProps> = ({ label, value, theme, onChange }) => {
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName="eventsfeed-showorganizer-property-pane" styles={{ background: 'transparent' }}>
...
export default ShowOrganizerHost;
