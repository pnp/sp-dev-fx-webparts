...
import { IShowFiltersComponentProps } from '../../models/IShowFiltersProps';

const ShowFiltersHost: React.FC<IShowFiltersComponentProps> = ({ label, value, theme, onChange }) => {
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName="eventsfeed-showfilters-property-pane" styles={{ background: 'transparent' }}>
...
export default ShowFiltersHost;
