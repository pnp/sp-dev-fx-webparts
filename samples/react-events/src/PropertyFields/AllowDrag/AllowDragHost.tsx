...
const AllowDragHost: React.FC<IAllowDragComponentProps> = ({ label, value, theme, onChange }) => {
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName="eventsfeed-allowdrag-property-pane" styles={{ background: 'transparent' }}>
