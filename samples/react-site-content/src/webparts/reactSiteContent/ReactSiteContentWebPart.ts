...
import * as strings from "ReactSiteContentWebPartStrings";
import ReactSiteContent from "./components/ReactSiteContent";
import { IReactSiteContentProps } from "./components/IReactSiteContentProps";
import { SPService } from "./services/SPService";

export interface IReactSiteContentWebPartProps {
  description: string;
}
