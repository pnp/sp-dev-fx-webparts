...
function _hasReact() {
    var react = ComponentStore_1.default.instance.getComponentById(componentConstants.reactComponentId);
    var reactDom = ComponentStore_1.default.instance.getComponentById(componentConstants.reactDomComponentId);
    return !!(react && reactDom);
}
function _tryFillDevToolsFabric() {
    var fabricPromise = ComponentStore_1.default.instance.getComponentById(componentConstants.officeUiFabricReactComponentId);
    if (fabricPromise) {
...
function _loadDeveloperTools(fabricLoadedPromise) {
    var loadDeveloperTools = function () {
        __webpack_chunk_load__( 3, function (requireFn) {
    ...
    fabricLoadedPromise.then(function (fabricLoaded) {
        if (!fabricLoaded) {
            __webpack_chunk_load__( 2, loadDeveloperTools);
        }
        else {
            loadDeveloperTools();
        }
