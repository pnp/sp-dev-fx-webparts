...
var DevDeployTask = (function (_super) {
    ...
    DevDeployTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        var manifests = cumulativeManifestProcessor.discoverManifestsForPackage(process.cwd(), cumulativeManifestProcessor_1.ForceSearch.deepSparse);
        var manifestsArray = [];
