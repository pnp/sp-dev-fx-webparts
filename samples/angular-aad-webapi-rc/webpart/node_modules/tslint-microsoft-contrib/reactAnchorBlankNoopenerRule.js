...
function isRelAttributeValue(attribute) {
    ...
    if (attribute.initializer.kind === SyntaxKind_1.SyntaxKind.current().JsxExpression) {
        var expression = attribute.initializer;
        if (expression.expression != null && expression.expression.kind !== SyntaxKind_1.SyntaxKind.current().StringLiteral) {
            return true;
        }
    }
