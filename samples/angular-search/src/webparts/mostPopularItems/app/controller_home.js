    ...
    function ($rootScope, $scope, $http, $location, $window) {
        ...
        $rootScope.$on('configurationChanged', function (event, args) {
            ...
            if (args.url != null && args.url.length > 0) {
                ...
                if ("https://"+window.location.hostname.toLowerCase() == "https://wwww.contoso.com/") {
        ...
        $scope.loadMessages = function () {
            ...
            var endpointurl = "https://" + window.location.hostname + "/_api/search/query?querytext='path:" + $scope.url + "'&rowlimit=500&sortlist='ViewsLifeTime:descending'";
            ...
            $http({
                ...
                var results = data.data.d.query.PrimaryQueryResult.RelevantResults.Table.Rows.results;
