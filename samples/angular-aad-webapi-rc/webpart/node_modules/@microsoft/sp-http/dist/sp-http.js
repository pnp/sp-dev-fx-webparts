define("c07208f0-ea3b-4c1a-9965-ac1b825211a6", ["@microsoft/sp-core-library","@microsoft/decorators","@microsoft/sp-lodash-subset","@ms/sp-telemetry"], function(__WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_11__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HttpClientConfigurations = HttpClientConfiguration_1.HttpClientConfigurations;
	...
	exports.SPHttpClientConfigurations = SPHttpClientConfiguration_1.SPHttpClientConfigurations;
	...
	exports.SPHttpClientBatchConfigurations = SPHttpClientBatchConfiguration_1.SPHttpClientBatchConfigurations;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HttpClientConfiguration = (function () {
	    ...
	    Object.defineProperty(HttpClientConfiguration.prototype, "consoleLogging", {
	        get: function () {
	            return this.flags.consoleLogging;
	        },
	        enumerable: true,
	        configurable: true
	    });
	    HttpClientConfiguration.prototype.initializeFlags = function () {
	        this.flags.consoleLogging = false;
	    };
	...
	var HttpClientConfigurations = (function () {
	    function HttpClientConfigurations() {
	    }
	    HttpClientConfigurations.none = new HttpClientConfiguration({});
	    HttpClientConfigurations.v1 = new HttpClientConfiguration({
	        consoleLogging: true
	    });
	    return HttpClientConfigurations;
	}());
	exports.HttpClientConfigurations = HttpClientConfigurations;
	exports.predefinedConfigurations = {
	    none: new HttpClientConfiguration({}),
	    v1: new HttpClientConfiguration({ consoleLogging: true })
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HttpClientResponse = (function () {
	    ...
	    HttpClientResponse.error = function () { return Response.error(); };
	    HttpClientResponse.redirect = function (url, status) { return Response.redirect(url, status); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPHttpClientConfiguration = (function (_super) {
	    ...
	    function SPHttpClientConfiguration(flags, overrideFlags) {
	        _super.call(this, flags, overrideFlags);
	    }
	...
	var SPHttpClientConfigurations = (function () {
	    function SPHttpClientConfigurations() {
	    }
	    SPHttpClientConfigurations.none = new SPHttpClientConfiguration({});
	    SPHttpClientConfigurations.v1 = new SPHttpClientConfiguration(HttpClientConfiguration_1.HttpClientConfigurations.v1, {
	        jsonRequest: true,
	        jsonResponse: true,
	    ...
	    return SPHttpClientConfigurations;
	}());
	exports.SPHttpClientConfigurations = SPHttpClientConfigurations;
	exports.predefinedConfigurations = {
	    none: new SPHttpClientConfiguration({}),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPHttpClientResponse = (function (_super) {
	    ...
	    SPHttpClientResponse = __decorate([
	        decorators_1.sealed
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPHttpClientBatchConfigurations = (function () {
	    function SPHttpClientBatchConfigurations() {
	    }
	    SPHttpClientBatchConfigurations.readonlynone = new SPHttpClientBatchConfiguration({});
	    SPHttpClientBatchConfigurations.v1 = new SPHttpClientBatchConfiguration(HttpClientConfiguration_1.HttpClientConfigurations.v1, {
	        jsonRequest: true,
	        jsonResponse: true
	    });
	    return SPHttpClientBatchConfigurations;
	}());
	exports.SPHttpClientBatchConfigurations = SPHttpClientBatchConfigurations;
	exports.predefinedConfigurations = {
	    none: new SPHttpClientBatchConfiguration({}),
	...
	var OAuthUtility = (function () {
	    ...
	    OAuthUtility.prototype._buildErrorFromResponse = function (serverErrorResponse) {
	        ...
	        return new OAuthUtilityError_1.default(OAuthUtilityError_1.OAuthUtilityErrorType.serverError, {
	            ...
	            correlationId: serverErrorResponse.correlationId,
	            redirectUrl: serverErrorResponse['error.redirectUrl']
	        });
	    };
	    OAuthUtility.prototype._getErrorCodeFromResponseCode = function (serverErrorResponse) {
	        ...
	        if (typeof serverErrorResponse.message === 'string') {
	            ...
	            errorCode = Number(responseErrorCode);
	        }
	        return errorCode;
	    };
