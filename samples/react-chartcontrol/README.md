...
![Bar Chart with Staic Data](./assets/BarChartStatic.png)
...
![Area Chart](./assets/AreaChart.png)
...
Sorry, you can't pop the bubbles, but it was very tempting.
...
![Doughnut with Patterns](./assets/DoughnutPatterns.png)
...
![Real Data Sample](./assets/RealDataDonut.png)
...
Unfortunately, at the time of this writing, I was getting a lot of bugs with the dynamic data consumer web part, so I removed it from the samples. It will be re-added later.
...
-------|----|--------
1.0|December 29, 2018|Initial release
