...
import { IShowShareComponentProps } from '../../models/IShowShareProps';

const ShowShareHost: React.FC<IShowShareComponentProps> = ({
  label,
  value,
  theme,
  onChange,
  ...
  return (
    <FluentUIProvider
      ...
      applicationName="newfeed-showshare-property-pane"
    >
