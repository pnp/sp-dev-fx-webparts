...
import { IShowAuthorDateComponentProps } from '../../models/IShowAuthorDateProps';

const ShowAuthorDateHost: React.FC<IShowAuthorDateComponentProps> = ({
  label,
  value,
  theme,
  onChange,
  ...
  return (
    <FluentUIProvider
      ...
      applicationName="newfeed-showauthordate-property-pane"
    >
...
export default ShowAuthorDateHost;
