...
import { IPersonaCardContainerProps } from './IPersonaCardContainerProps';
import { IPersonaCardContainerState } from './IPersonaCardContainerState';
...
export class MockPersonaCardContainer extends React.Component<IPersonaCardContainerProps, IPersonaCardContainerState>{
    ...
    private _onSearchBoxChange(sbQuery:string) :void{           
        ...
        this._getSearchResults(sbQuery, 1);
    }
