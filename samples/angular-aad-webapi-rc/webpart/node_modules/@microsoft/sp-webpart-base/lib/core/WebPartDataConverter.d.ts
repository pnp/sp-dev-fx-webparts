...
export declare class WebPartDataConverter {
     ...
     */
    convertServerProcessedDataToHtml(serverContent: ISerializedServerProcessedData): string;
    /**
     ...
     *
     */
    convertServerProcessedHtmlToData(htmlString: string): ISerializedServerProcessedData;
    /**
     * Get the HTML equivalent string for a server processed prop type.
     */
    private _getHtmlString(propName, propType, propValue);
    /**
     ...
     */
    private _normalizeHTML(htmlString);
}
declare var _default: WebPartDataConverter;
