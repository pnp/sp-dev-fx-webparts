...
describe('UrlQueryParameterCollection tests', function () {
    var _loop_1 = function(test_1) {
        it(test_1.testName, function (done) {
            ...
            chai_1.assert.deepEqual(urlQuery.getValue('test'), undefined);
            chai_1.assert.deepEqual(urlQuery.getValues('test'), undefined);
            done();
        });
    };
    ...
    it('should retrieve query parameter value with multiple = signs', function (done) {
        ...
        chai_1.assert.deepEqual(urlQuery.getValues('test'), ['a=b=c', undefined]);
        done();
    });
    it('should return empty query parameter', function (done) {
        ...
        chai_1.assert.deepEqual(urlQuery.getValue(undefined), undefined);
        chai_1.assert.deepEqual(urlQuery.getValues(undefined), [undefined, undefined]);
        done();
    });
});
