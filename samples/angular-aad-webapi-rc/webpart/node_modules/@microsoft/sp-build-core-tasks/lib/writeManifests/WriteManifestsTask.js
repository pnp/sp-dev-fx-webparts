...
var WriteManifestsTask = (function (_super) {
    ...
    WriteManifestsTask.prototype.executeTask = function (gulp, completeCallback) {
        ...
        var manifestIds = {};
        var tasks = [];
        var manifestVersion = this.properties.deployEntries.length === 1
        ...
        this.properties.deployEntries.forEach(function (deployEntry) {
            ...
            if (shouldProduceDebugManifests) {
                ...
                var debugManifest = _this._generateManifest(deployEntry, loaderConfig, manifestVersion);
            ...
            if (shouldProduceProductionManifests) {
                ...
                var productionManifest = _this._generateManifest(deployEntry, loaderConfig, manifestVersion);
    ...
    WriteManifestsTask.prototype._generateManifest = function (deployEntry, loaderConfig, manifestVersion) {
    ...
    WriteManifestsTask.prototype._getPackageVersion = function () {
