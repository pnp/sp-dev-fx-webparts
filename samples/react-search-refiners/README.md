...
2.1.1.0 | Oct 30, 2018 | <ul><li>Bug fix for editing custom template.</li><li>Added support for Page context query variables.</li><li>Added `getUniqueCount` helper function.</li></ul>
