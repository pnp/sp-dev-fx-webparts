...
import { IShowViewsLikesComponentProps } from '../../models/IShowViewsLikesProps';

const ShowViewsLikesHost: React.FC<IShowViewsLikesComponentProps> = ({
  label,
  value,
  theme,
  onChange,
  ...
  return (
    <FluentUIProvider
      ...
      applicationName="newfeed-showviewslikes-property-pane"
    >
...
export default ShowViewsLikesHost;
