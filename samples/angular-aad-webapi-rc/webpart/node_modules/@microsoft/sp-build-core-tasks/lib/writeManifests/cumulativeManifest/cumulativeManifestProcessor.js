...
})(exports.ForceSearch || (exports.ForceSearch = {}));
var ForceSearch = exports.ForceSearch;
var CumulativeManifestProcessor = (function () {
    ...
    CumulativeManifestProcessor.prototype.generateCumulativeManifest = function (gulp, debugManifests) {
        ...
        var referencedProjectManifests = this.discoverManifestsForPackage(this._parentTask.buildConfig.rootPath, ForceSearch.shallow);
        var result = [];
    ...
    CumulativeManifestProcessor.prototype.discoverManifestsForPackage = function (packagePath, forceSearchMode) {
        var _this = this;
        var referencedProjectManifests = {};
        var tempPath = path.join(packagePath, this._parentTask.buildConfig.tempFolder || 'temp');
        var distPath = path.join(packagePath, this._parentTask.buildConfig.distFolder || 'dist');
                ...
                if (referencedPackagePath) {
                    var recursiveForceSearchMode = (forceSearchMode === ForceSearch.shallow)
                        ...
                        : (forceSearchMode === ForceSearch.deepSparseIgnoreFirstProject
                            ...
                            : forceSearchMode);
                    var manifests = _this.discoverManifestsForPackage(referencedPackagePath, recursiveForceSearchMode);
