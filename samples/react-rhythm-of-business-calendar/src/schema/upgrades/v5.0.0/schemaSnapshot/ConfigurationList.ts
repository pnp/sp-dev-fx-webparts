...
export const Field_TemplateView: IChoiceFieldDefinition = {
    type: FieldType.Choice,
    name: 'TemplateView',
...
export const Field_UseAddToOutlook: IBooleanFieldDefinition = {
    type: FieldType.Boolean,
...
export const Field_ListViewColumn: IChoiceFieldDefinition = {
    type: FieldType.Choice,
    name: 'ListViewColumn',
