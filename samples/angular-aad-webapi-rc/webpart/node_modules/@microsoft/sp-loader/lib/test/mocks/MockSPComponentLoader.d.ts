...
import { ISPComponentLoader, IApplicationPreloadedData, ILoadScriptOptions } from './../../ISPComponentLoader';
export default class MockSPComponentLoader implements ISPComponentLoader {
