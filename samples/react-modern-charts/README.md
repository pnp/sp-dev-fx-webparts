...
You can try looking at [issues related to this sample](https://github.com/pnp/sp-dev-fx-webparts/labels/react-modern-charts) to see if anybody else is having the same issues.
