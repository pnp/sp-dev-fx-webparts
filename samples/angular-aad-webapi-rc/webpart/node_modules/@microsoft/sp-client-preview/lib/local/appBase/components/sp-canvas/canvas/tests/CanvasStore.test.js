...
describe('Canvas Store tests', function () {
    ...
    it('should open and close the delete button dialog as expected', function (done) {
        ...
        canvasStore.handleDeleteButtonClicked(0, undefined);
        chai_1.expect(canvasStore.isDeleteDialogOpen).to.be.true;
        canvasStore.handleDeleteDialogDismiss();
        chai_1.expect(canvasStore.isDeleteDialogOpen).to.be.false;
        canvasStore.handleDeleteDialogConfirmation();
        done();
    });
    it('should open and close the delete button dialog as expected with layout flight enabled', function (done) {
        ...
        store.handleDeleteButtonClicked(undefined, layout);
        chai_1.expect(store.isDeleteDialogOpen).to.be.true;
        store.handleDeleteDialogDismiss();
        chai_1.expect(store.isDeleteDialogOpen).to.be.false;
        canvasStore.handleDeleteDialogConfirmation();
        canvasFlightController(resetFlightId);
        done();
    });
