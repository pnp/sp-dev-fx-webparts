...
import { IconButton, IIconProps, PrimaryButton } from 'office-ui-fabric-react';
...
export function ExportListItemsToPDF(props: IExportToPDF) {
    ...
    return (
        ...
        // />
        <Button style={{color:"black"}} variant="outlined" onClick={() => genearatePDF()} startIcon={<CloudDownload />}>
