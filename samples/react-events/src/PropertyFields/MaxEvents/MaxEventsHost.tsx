...
import { IMaxEventsComponentProps } from '../../models/IMaxEventsProps';

const MaxEventsHost: React.FC<IMaxEventsComponentProps> = ({
  label,
  value,
  min,
  max,
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName={'eventsfeed-maxevents-property-pane'} styles={{ background: 'transparent' }}>
