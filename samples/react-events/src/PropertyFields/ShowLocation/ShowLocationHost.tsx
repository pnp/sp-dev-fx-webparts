...
import { IShowLocationComponentProps } from '../../models/IShowLocationProps';

const ShowLocationHost: React.FC<IShowLocationComponentProps> = ({ label, value, theme, onChange }) => {
  ...
  return (
    <FluentUIProvider theme={theme} targetDocument={document} applicationName="eventsfeed-showlocation-property-pane" styles={{ background: 'transparent' }}>
...
export default ShowLocationHost;
