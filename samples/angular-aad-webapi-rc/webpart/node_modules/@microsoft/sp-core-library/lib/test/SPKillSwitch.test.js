...
describe('SPKillSwitches tests', function () {
    var undefinedKillSwitches = undefined;
    var nullKillSwitches = null;
    ...
    it('Can parse an undefined killswitch array', function () {
        SPKillSwitch_1.default.initialize(undefinedKillSwitches);
        chai_1.assert.isTrue(true);
    });
    it('Can parse a null killswitch array', function () {
        SPKillSwitch_1.default.initialize(nullKillSwitches);
        chai_1.assert.isTrue(true);
    });
    ...
    it('Can parse an array with both valid and invalidkillswitches', function () {
        ...
        describe('SPKillSwitches object tests', function () {
            it('Can find a killswitch contained in SPKillSwitch object', function () {
                chai_1.assert.isTrue(SPKillSwitch_1.default.isActivated(Guid_1.default.tryParse('9d4f312c-e365-45b4-b6ef-fa24e512e7e5'), '9/17/2015', 'SPEED_FeatureX'));
            });
            it('Cannot find a killswitch not contained in a SPKillSwitch object', function () {
                chai_1.assert.isTrue(!SPKillSwitch_1.default.isActivated(Guid_1.default.tryParse('{e25dc355-64df-4d3d-beb8-001e5dae531c}'), '9/17/2015', 'SPEED_FeatureX'));
            });
            it('Cannot find an invalid killswitch not contained in a SPKillSwitch object', function () {
                chai_1.assert.isTrue(!SPKillSwitch_1.default.isActivated(Guid_1.default.tryParse('not-a-guid'), '9/17/2015', 'SPEED_FeatureX'));
            });
            it('Cannot find a null killswitch in a SPKillSwitch object', function () {
                chai_1.assert.isTrue(!SPKillSwitch_1.default.isActivated(null, '9/17/2015', 'SPEED_FeatureX'));
            });
            it('Cannot find an undefined killswitch in a SPKillSwitch object', function () {
                chai_1.assert.isTrue(!SPKillSwitch_1.default.isActivated(undefined, '9/17/2015', 'SPEED_FeatureX'));
            });
        });
        chai_1.assert.isTrue(true);
    });
