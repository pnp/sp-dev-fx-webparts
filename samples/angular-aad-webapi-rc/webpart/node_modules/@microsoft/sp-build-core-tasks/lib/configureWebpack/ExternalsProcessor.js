...
function getLinkedExternals(gulpTask) {
    ...
    var discoveredManifests = cumulativeManifestProcessor.discoverManifestsForPackage(process.cwd(), cumulativeManifestProcessor_1.ForceSearch.deepSparseIgnoreFirstProject);
    var result = {};
