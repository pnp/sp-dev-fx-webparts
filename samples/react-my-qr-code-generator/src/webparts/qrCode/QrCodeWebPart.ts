...
export default class QrCodeWebPart extends BaseClientSideWebPart<IQrCodeWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IQrCodeProps> = React.createElement(
      QrCode,
      {
        ...
        currentPageUrl: this.context.pageContext.web.absoluteUrl + this.context.pageContext.site.serverRequestPath,
  ...
  protected onThemeChanged(currentTheme: IReadonlyTheme | undefined): void {
    ...
    // User requested NO dark mode. We will ignore inverted state.
    // We only apply semantic colors if they are useful, but ensure we stay in light mode.
